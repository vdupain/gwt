...
public class UIBinderComposite extends Composite {

    private static UIBinderCompositeUiBinder uiBinder = GWT.create(UIBinderCompositeUiBinder.class);
    ...
    interface UIBinderCompositeUiBinder extends UiBinder<Widget, UIBinderComposite> {
    }
