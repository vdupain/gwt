...
public class DefaultDispatchUrlBuilder implements DispatchUrlBuilder {
	...
	/**
	 * Le nom par défaut du chemin relatif (au module) de la servlet RPC du dispatcher.
	 *
	...
	/**
	 * C'est le nom du RPC dispatcher définit dans web.xml. Il est en générale à "dispatch".
	 * 
	 * <pre>
	 * 	<servlet>
	 ...
	 * 
	 * http://127.0.0.1:8080/${context-web}/${nom-module-gwt}/dispatch/${nom-class-action}
	 * 
	 * http://127.0.0.1:8080/ssgd/SSGD/dispatch/fr.generali.gwt.dispatch.shared.IncrementCounter
	 */
	@Override
